      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            ...
            <p class="lead" style="font-size: 100%" style="text-align: center">As we develop SpareStub, we would love ideas, feedback and Beta users! If you would like periodic updates on SpareStub development and release, or would like to be included in helping to design and test the product, click below and send us an email! </p>
            <p class="lead" style="text-align: center"><a href="mailto:stephanie@sparestub.com" class="btn btn-lg btn-default">Sign Up Form</a></p>
          </div>
