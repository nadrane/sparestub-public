"""
This file is from the django-storages project and has been converted to work with Python3.
I would have cloned to repo, but it isn't a git repo, and I frankly have no interest in learning another
SVN system at the moment.
"""
...
from django.utils.encoding import force_text, smart_bytes, filepath_to_uri
